...
public class ClientDetailsController {
	...
	public String clientDetails(Model model) {
		// List<OauthClientDetailsDto> clientDetailsDtoList =
		// oauthService.loadAllOauthClientDetailsDtos();
		List<OauthClientDetailsDto> clientDetailsDtoList = null;
	...
	public String testClient(@PathVariable("clientId") String clientId, Model model) {
		...
		// oauthService.loadOauthClientDetailsDto(clientId);
		OauthClientDetailsDto clientDetailsDto = null;
