...
INSERT INTO `oauth2`.`oauth_client_details` (`client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `create_time`, `archived`, `trusted`, `autoapprove`) VALUES ('cd49317c121b4a7c981d5d3720508b81', 'unity-resource,mobile-resource', '8382d723946c0b789ee32711afb79b3f', 'read,write', 'client_credentials', '', '', NULL, NULL, '', '2018-08-08 17:56:02', '0', '0', '');
